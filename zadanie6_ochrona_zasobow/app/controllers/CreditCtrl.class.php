...
class CreditCtrl {
    ...
    public function action_creditCompute(){
        $this->getParams();
        ...
        if ($this->validate()) {
            ...
            // Sprawdzenie uprawnień dla dużych kwot
            if (!inRole('admin')) {
    ...
    public function action_creditView(){
        $this->msgs->addInfo('Witaj w kalkulatorze kredytowym');
        $this->generateView();
    }
