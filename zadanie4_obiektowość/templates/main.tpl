    ...
    <nav class="navbar navbar-expand-lg navbar-dark nav-custom">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                <a class="nav-link {if isset($current_page) && $current_page == 'simple'}active{/if}" href="{$app_url}/app/calc.php">
                    <i class="fas fa-calculator me-1"></i>Prosty
                </a>
                <a class="nav-link {if isset($current_page) && $current_page == 'credit'}active{/if}" href="{$app_url}/app/credit_calc.php">
